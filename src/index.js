...
import { Text, View, ViewPropTypes, ScrollView, Dimensions, TouchableOpacity, Platform, ActivityIndicator, TouchableHighlightBase } from 'react-native';
...
export default class Swiper extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.props.autoplay) {
      // If autoplay props updated to true when it was previously false, autoplay immediately
      if (!prevProps.autoplay) this.autoplay();
    } else if (this.autoplayTimer) {
      clearTimeout(this.autoplayTimer);
    }

    if (this.props.index !== prevProps.index) {
      this.setState(this.initState(this.props, prevProps.index !== this.props.index));
      return;
    }
   ...
   */
  autoplay = () => {
    if (!Array.isArray(this.state.children) || !this.props.autoplay || this.internals.isScrolling || this.state.autoplayEnd) return;
